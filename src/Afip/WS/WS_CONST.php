...
class WS_CONST
{
    ...
    const WS_SR_PADRON_CONSTANCIA_INSCRIPCION_PRODUCTION = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Production' . DIRECTORY_SEPARATOR . 'WS_SR_PADRON_A13.wsdl';
    const WS_SR_PADRON_CONSTANCIA_INSCRIPCION_TESTING = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Testing' . DIRECTORY_SEPARATOR . 'WS_SR_PADRON_A13.wsdl';
