...
class WS_CONST
{
    ...
    const WSFEXV1_PRODUCTION = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Production' . DIRECTORY_SEPARATOR . 'WSFEXV1.wsdl';
    const WSFEXV1_TESTING = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Testing' . DIRECTORY_SEPARATOR . 'WSFEXV1.wsdl';
    ...
    public static function find($name)
    {
        ...
        $ws = [
            ...
            'ARBA' => "{$path}\ARBA",
            'FACTURA EXPORTACION' => "{$path}\WSFEXV1",
        ];
