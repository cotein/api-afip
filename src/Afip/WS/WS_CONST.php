...
class WS_CONST
{
    ...
    const WSFEX_PRODUCTION = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Production' . DIRECTORY_SEPARATOR . 'WSFEXV1.wsdl';
    const WSFEX_TESTING = __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Wsdl' . DIRECTORY_SEPARATOR . 'Testing' . DIRECTORY_SEPARATOR . 'WSFEXV1.wsdl';
